import{R as l}from"./iframe-BsJ-CPdr.js";import{D as u}from"./data-editor-all-DtPkoeHH.js";import{B as p,D as m,P as f,a as h,d as g}from"./utils-CdsLDgjh.js";import{S as v}from"./story-utils-CdSAXySY.js";import"./preload-helper-C1FmrZbK.js";import"./image-window-loader-DxEFrg0V.js";import"./throttle-c2Jp8PEZ.js";import"./marked.esm-Cy9xk-ev.js";import"./flatten-BSdzrqUm.js";import"./scrolling-data-grid-CoXaNyV4.js";import"./index-D_kXk1yT.js";import"./useResizeDetector-D3CMph9U.js";const O={title:"Glide-Data-Grid/DataEditor Demos",decorators:[o=>l.createElement(v,null,l.createElement(p,{title:"Custom header icons",description:l.createElement(l.Fragment,null,l.createElement(m,null,"You can provide overrides for the default icons by passing the"," ",l.createElement(f,null,"headerIcons")," prop."))},l.createElement(o,null)))]},t=()=>{const{cols:o,getCellContent:d,onColumnResize:i,setCellValue:s}=h(),a=l.useMemo(()=>{const e=[...o];return e[3]={...e[3],title:"CUSTOM ICON",icon:"custom",width:200},e},[o]),c=l.useMemo(()=>({custom:e=>`<svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg>`}),[]);return l.createElement(u,{...g,getCellContent:d,columns:a,onCellEdited:s,onColumnResize:i,headerIcons:c,rows:1e3})};var r,n,C;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`() => {
  const {
    cols,
    getCellContent,
    onColumnResize,
...
}`,...(C=(n=t.parameters)==null?void 0:n.docs)==null?void 0:C.source}}};const z=["CustomHeaderIcons"];export{t as CustomHeaderIcons,z as __namedExportsOrder,O as default};
