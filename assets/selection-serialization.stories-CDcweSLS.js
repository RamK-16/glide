import{R as e}from"./iframe-VjYuGMsY.js";import{D as S}from"./data-editor-all-C18pEU2z.js";import{u as i,B as R,D as k,P as g}from"./utils-DA5KvXiW.js";import{C as n}from"./image-window-loader-B8cvJCVw.js";import{S as D}from"./story-utils-Dv2OgOS1.js";import"./preload-helper-C1FmrZbK.js";import"./scrolling-data-grid-Dlt80JY1.js";import"./marked.esm-CZueurBS.js";import"./index-D_kXk1yT.js";import"./useResizeDetector-1xUx3BY8.js";const I={title:"Glide-Data-Grid/DataEditor Demos",decorators:[l=>e.createElement(D,null,e.createElement(l,null))]},u=()=>{const{cols:l,getCellContent:a}=i(30,!0,!0),[t,s]=e.useState(()=>{try{const o=localStorage.getItem("grid-selection-demo");if(o!==null){const r=JSON.parse(o);return{columns:n.create(Array.isArray(r.columns)?r.columns:[]),rows:n.create(Array.isArray(r.rows)?r.rows:[]),current:r.current}}}catch(o){console.error("Failed to restore selection",o)}return{columns:n.empty(),rows:n.empty()}});e.useEffect(()=>{const o={columns:t.columns.items,rows:t.rows.items,current:t.current};localStorage.setItem("grid-selection-demo",JSON.stringify(o))},[t]);const c=()=>{s({columns:n.empty(),rows:n.empty(),current:void 0})},m=()=>{s({columns:n.create([[2,5],[8,10]]),rows:n.create([[1,4],[10,15],[20,23]]),current:{cell:[3,5],range:{x:3,y:5,width:1,height:1},rangeStack:[]}})};return e.createElement(R,{title:"Selection Serialization",description:e.createElement(k,null,"This example demonstrates how to serialize and persist grid selections using the new"," ",e.createElement(g,null,"CompactSelection.create()")," and ",e.createElement(g,null,".items")," APIs. The selection is automatically saved to localStorage and restored when the page refreshes.",e.createElement("br",null),e.createElement("br",null),e.createElement("button",{onClick:m,style:{marginRight:8}},"Create Example Selection"),e.createElement("button",{onClick:c},"Clear Selection"),e.createElement("br",null),e.createElement("br",null),e.createElement("strong",null,"Current selection:")," ",t.rows.length," rows, ",t.columns.length," columns",e.createElement("br",null),e.createElement("strong",null,"Persisted data:")," ",e.createElement("code",null,JSON.stringify({columns:t.columns.items,rows:t.rows.items})))},e.createElement(S,{...i(30,!1),columns:l,getCellContent:a,rows:1e4,gridSelection:t,onGridSelectionChange:s,rowMarkers:"both",columnSelect:"multi"}))},d=()=>{const{cols:l,getCellContent:a}=i(30,!0,!0),[t,s]=e.useState({columns:n.empty(),rows:n.empty()}),[c,m]=e.useState({columns:n.empty(),rows:n.empty()}),o=()=>{const r={columns:t.columns.items,rows:t.rows.items,current:t.current},w=JSON.stringify(r);console.log("Serialized selection:",w);const p=JSON.parse(w),v={columns:n.create(p.columns),rows:n.create(p.rows),current:p.current};m(v)};return e.createElement(R,{title:"Selection Round Trip",description:e.createElement(k,null,"This example demonstrates a complete round trip: create a selection, serialize it to JSON, then deserialize it back to a ",e.createElement(g,null,"CompactSelection")," using the new APIs.",e.createElement("br",null),e.createElement("br",null),e.createElement("button",{onClick:o},"Perform Round Trip"),e.createElement("br",null),e.createElement("br",null),e.createElement("strong",null,"Original equals restored:")," ",t.columns.equals(c.columns)&&t.rows.equals(c.rows)?"✅ Yes":"❌ No")},e.createElement("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,height:600}},e.createElement("div",null,e.createElement("h3",null,"Original Selection"),e.createElement(S,{...i(30,!1),columns:l,getCellContent:a,rows:1e3,gridSelection:t,onGridSelectionChange:s,rowMarkers:"both",columnSelect:"multi"})),e.createElement("div",null,e.createElement("h3",null,"Restored Selection"),e.createElement(S,{...i(30,!1),columns:l,getCellContent:a,rows:1e3,gridSelection:c,onGridSelectionChange:m,rowMarkers:"both",columnSelect:"multi"}))))};var C,h,y;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`() => {
  const {
    cols,
    getCellContent
  ...
  return <BeautifulWrapper title="Selection Round Trip" description={<Description>
                    ...
                    {originalSelection.columns.equals(restoredSelection.columns) && originalSelection.rows.equals(restoredSelection.rows) ? "✅ Yes" : "❌ No"}
                </Description>}>
            <div style={{
      display: "grid",
...
}`,...(b=(f=d.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};const q=["SelectionSerialization","SelectionRoundTrip"];export{d as SelectionRoundTrip,u as SelectionSerialization,q as __namedExportsOrder,I as default};
