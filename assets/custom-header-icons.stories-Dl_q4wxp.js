import{R as l}from"./iframe-VjYuGMsY.js";import{D as u}from"./data-editor-all-C18pEU2z.js";import{B as p,D as f,P as m,a as h,d as g}from"./utils-DA5KvXiW.js";import{S as v}from"./story-utils-Dv2OgOS1.js";import"./preload-helper-C1FmrZbK.js";import"./image-window-loader-B8cvJCVw.js";import"./marked.esm-CZueurBS.js";import"./scrolling-data-grid-Dlt80JY1.js";import"./index-D_kXk1yT.js";import"./useResizeDetector-1xUx3BY8.js";const R={title:"Glide-Data-Grid/DataEditor Demos",decorators:[o=>l.createElement(v,null,l.createElement(p,{title:"Custom header icons",description:l.createElement(l.Fragment,null,l.createElement(f,null,"You can provide overrides for the default icons by passing the"," ",l.createElement(m,null,"headerIcons")," prop."))},l.createElement(o,null)))]},t=()=>{const{cols:o,getCellContent:d,onColumnResize:s,setCellValue:i}=h(),a=l.useMemo(()=>{const e=[...o];return e[3]={...e[3],title:"CUSTOM ICON",icon:"custom",width:200},e},[o]),c=l.useMemo(()=>({custom:e=>`<svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg>`}),[]);return l.createElement(u,{...g,getCellContent:d,columns:a,onCellEdited:i,onColumnResize:s,headerIcons:c,rows:1e3})};var n,r,C;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`() => {
  const {
    cols,
    getCellContent,
    onColumnResize,
...
}`,...(C=(r=t.parameters)==null?void 0:r.docs)==null?void 0:C.source}}};const S=["CustomHeaderIcons"];export{t as CustomHeaderIcons,S as __namedExportsOrder,R as default};
