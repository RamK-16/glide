import{R as e}from"./iframe-DUOMWMKB.js";import{D as f}from"./data-editor-all-CIEmZ3Oy.js";import{B as d,D as C,P as h,u as x,d as w}from"./utils-Cjk2GE-g.js";import{G as y}from"./image-window-loader-DQVbokRp.js";import{S as W}from"./story-utils-CVcEWNI0.js";import{r as D}from"./throttle-CkIxoYA6.js";import{y as E}from"./index-D_kXk1yT.js";import"./preload-helper-C1FmrZbK.js";import"./flatten-Dh3Y6Y7r.js";import"./scrolling-data-grid-BB7XyoHK.js";import"./marked.esm-CNbZRF2T.js";import"./useResizeDetector-CisFguVS.js";const S={title:"Glide-Data-Grid/DataEditor Demos",decorators:[t=>e.createElement(W,null,e.createElement(d,{title:"Wrapping Text",description:e.createElement(C,null,"Text cells can have wrapping text by setting the ",e.createElement(h,null,"allowWrapping")," prop to true.")},e.createElement(t,null)))]},n=t=>{const{cols:m,getCellContent:l,onColumnResize:c}=x(6),r=e.useMemo(()=>D(0,100).map(()=>E.lorem.sentence(t.length)),[t.length]),g=e.useCallback(o=>{const[u,a]=o;return u===0?{kind:y.Text,allowOverlay:!0,displayData:`${a},
${r[a%r.length]}`,data:`${a}, 
